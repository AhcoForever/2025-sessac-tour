...
class ContentDetailPage extends StatefulWidget {
  ...
  const ContentDetailPage({Key? key, required this.cid}) : super(key: key);
...
class _ContentDetailPageState extends State<ContentDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('콘텐츠 상세'), ),
      body: _isLoading
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // 관련 이미지 갤러리
                        if (_content!.relateImg.isNotEmpty) ...[
                          const Text(
                            '관련 이미지',
                            style: TextStyle(
                              fontSize: 20,
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: _content!.relateImg.length,
                        ...
                        if (_content!.extra != null) ...[
                          ...
                          if (_content!.extra!.cmmnHmpgUrl != null)
                            _buildInfoRow(
                              '홈페이지',
                              _content!.extra!.cmmnHmpgUrl!,
                            ),

                          if (_content!.extra!.cmmnUseTime != null)
                            _buildInfoRow(
                              '이용시간',
                              _content!.extra!.cmmnUseTime!,
                            ),

                          if (_content!.extra!.closedDays != null)
                            _buildInfoRow('휴무일', _content!.extra!.closedDays!),

                          if (_content!.extra!.cmmnImportant != null)
                            _buildInfoRow(
                              '중요정보',
                              _content!.extra!.cmmnImportant!,
                            ),
                        ],
